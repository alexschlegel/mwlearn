...
mwlt.Experiment.Show.Text('<color:blue>X</color>',[-horzOffset, 0],'window',hSample2);
mwlt.Experiment.Show.Text('<color:red>B</color>',[horzOffset, 0],'window',hSample2);
mwlt.Experiment.Show.Instructions(['Next, you will see two versions of the image.\n' ...
    'Choose the version that best matches the rotated image in your head, by pressing X for left or B for right.'], ...
    'figure', hSample2);
