...
function [rc, datafile] =SS(SSParams, varargin)
global ptb3
...
%     getptb;
    ...
    pll = SSParams.pll;      %list lengths for practice trials
    listlength = SSParams.listLength;  %array of list lengths, each replicated Ntpercond times
    Ntpercond = SSParams.trialsPerCond;       %trials per condition (ie list length)
    ...
    datafile = PathUnsplit(DirAppend(strDirCode, 'WMBattery','Data'),'SS','dat');
