...
function [rc, datafile, sum_datafile] =SSTM(subject,screenparms,SSTMParams)
...
%     getptb;
    ...
    NumT.Test=SSTMParams.numTrial;  % Number of test trial (Must bigger than 1)
    ...
    [datafile, sum_datafile] = RecTask(SubID,FileID,IntDate,NumT,RecExp,RecTrial,ShiftAns,Score,Order,RecRT,NumIndex);
