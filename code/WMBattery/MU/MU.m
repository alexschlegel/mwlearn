...
function [rc, datafile]=MU(subject,screenparms, MUParams)
global ptb3
global strDirCode
...
%     end
    ...
    Npracticetrials = MUParams.numPractice;
    Ntesttrials = MUParams.numTrial;
    ...
    datafile = PathUnsplit(DirAppend(strDirCode, 'WMBattery','Data'),'MU','dat');
