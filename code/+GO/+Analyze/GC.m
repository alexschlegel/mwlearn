...
% GO.Analyze.GC
% 
% Description:	calculate granger causality patterns between PCA/ICAed mask
%				functional data
% 
...
opt.outdir	= GO.Data.Directory(['gc' opt.tag]);
...
%have we done this already?
	param	= {opt.tag cSubject cMask opt.dim opt.ica opt.nd};
