...
%		dim:				(10) the number of PCA components to use
%		nd:					(1) the number of dimensions for the GC pattern
%							calculation
...
strDirOut	= GO.Data.Directory('gcmvpa');
...
%have we done this already?
	param	= {cSubject cMask opt.dim opt.nd opt.classifier opt.selection};
